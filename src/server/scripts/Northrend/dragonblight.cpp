...
#define SPELL_COMPELLED                             48714

#define ENTRY_JORDAN                                27237
#define ENTRY_ZIERHUT                               27235
#define ENTRY_GOODMAN                               27234
#define ENTRY_MERCER                                27236

#define SPELL_DENOUNCEMENT_JORDAN_KILL_CREDIT       48723
#define SPELL_DENOUNCEMENT_ZIERHUT_KILL_CREDIT      48725
#define SPELL_DENOUNCEMENT_GOODMAN_KILL_CREDIT      48727
#define SPELL_DENOUNCEMENT_MERCER_KILL_CREDIT       48729

//Spells
//JORDAN
#define SPELL_JODAN_WRATH                   50837
#define SPELL_JODAN_CONSECRATION            32773
//ZIERHUT
#define SPELL_ZIERHUT_TORCHE                50832
//GOODMAN
#define SPELL_GOODMAN_CRUSHARMOR            33661
#define SPELL_GOODMAN_CRACK                 15621
//MERCER
#define SPELL_MERCER_SUMMON_WARHORSE        50829
...
public:
    ...
    struct npc_denouncement_targetAI : public ScriptedAI
    {
        npc_denouncement_targetAI(Creature *c) : ScriptedAI(c) { }

        uint32 spell_Timer_1;
        uint32 spell_Timer_2;
